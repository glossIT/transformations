...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:import href="XSLT_steps/1GLOSSIT_page2tei.xsl"/> <!-- step 1 -->
    <xsl:import href="XSLT_steps/2GLOSSIT_pagenumbers.xsl"/> <!-- step 2 -->
    <xsl:import href="XSLT_steps/3GLOSSIT_textlineNumbers.xsl"/> <!-- step 3 -->
    <xsl:import href="XSLT_steps/4GLOSSIT_lbNumbers.xsl"/> <!-- step 4 --> 
    <xsl:import href="XSLT_steps/5GLOSSIT_lbReorder.xsl"/> <!-- step 5 -->   
    <xsl:import href="XSLT_steps/6GLOSSIT_glossIDs.xsl"/>
    <xsl:import href="XSLT_steps/7GLOSSIT_GlossLinking.xsl"/>
   ...
   <xsl:result-document href="{concat('../Output/',$docName, '.xml')}">
